...
Extracts WGMS AMPS power products for WG1169:
...
Outputs:
    amps_power_output/wg1169/all_ports_domain_slot_port_power.csv
    amps_power_output/wg1169/total_output_power_watts.csv
    amps_power_output/wg1169/solar_power_watts.csv
    amps_power_output/wg1169/total_battery_power_watts.csv
"""
...
def build_solar_power(solar_long: pd.DataFrame) -> pd.DataFrame:
    ...
    totals = (
        ...
        .sum()
        .reset_index()
        .rename(columns={"panelPower": "solar_power_W"})
    )
    return totals
