"""Export WG1170 AirSea, waves, and weather data to CSV files."""
...
def export_csv_files(output_dir: Path) -> None:
    ...
    source_dir = project_root / "data/wg1170/json"
    output_dir.mkdir(parents=True, exist_ok=True)

    datasets = {
        "airsea.csv": pd.read_csv(source_dir / "AirSeaWHIRLS_Decoded.csv"),
        "vegas.csv": pd.read_csv(source_dir / "VeGAS_decoded.csv"),
